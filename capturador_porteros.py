...
# ➜ PORTERO: actualizado a José / Nico
...
if evento == "Atajada":
    ...
    # ➜ Resultado de la parada: eliminada "Gran parada"
    ...
    # ➜ Origen: agregados Centro lateral y Centro frontal
    grid_selector("🧩 Origen",
                  ["Jugada","Segunda jugada","Penal","Falta","Córner",
                   "Centro lateral","Centro frontal"],
                  key="og", cols=3)
    ...
    # ➜ Tipo de Gol: agregados Centro lateral y Centro frontal
    ...
    # ➜ Origen del Error: agregados Posicionamiento y Lectura de juego
    grid_selector("🧩 Origen del Error",
                  ["Propio","Defensor","Buena jugada rival","Rebote",
                   "Posicionamiento","Lectura de juego"],
                  key="oe", cols=3)
